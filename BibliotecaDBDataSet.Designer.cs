...
namespace BibliotecaDB {
    ...
    public partial class BibliotecaDBDataSet : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsuariosRow AddUsuariosRow(string Nombre, string Apellido, string Email, string Telefono) {
...
namespace BibliotecaDB.BibliotecaDBDataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Usuarios] WHERE (([IdUsuario] = @Original_IdUsuario) AND ([Nombre] = @Original_Nombre) AND ([Apellido] = @Original_Apellido) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Telefono = 1 AND [Telefono] IS NULL) OR ([Telefono] = @Original_Telefono)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([Nombre], [Apellido], [Email], [Telefono]) VALUES (" +
                "@Nombre, @Apellido, @Email, @Telefono);\r\nSELECT IdUsuario, Nombre, Apellido, Ema" +
                "il, Telefono FROM Usuarios WHERE (IdUsuario = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuarios] SET [Nombre] = @Nombre, [Apellido] = @Apellido, [Email] = @Email, [Telefono] = @Telefono WHERE (([IdUsuario] = @Original_IdUsuario) AND ([Nombre] = @Original_Nombre) AND ([Apellido] = @Original_Apellido) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Telefono = 1 AND [Telefono] IS NULL) OR ([Telefono] = @Original_Telefono)));
SELECT IdUsuario, Nombre, Apellido, Email, Telefono FROM Usuarios WHERE (IdUsuario = @IdUsuario)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IdUsuario, Nombre, Apellido, Email, Telefono FROM dbo.Usuarios";
        ...
        public virtual int Delete(int Original_IdUsuario, string Original_Nombre, string Original_Apellido, string Original_Email, string Original_Telefono) {
        ...
        public virtual int Update(string Nombre, string Apellido, string Email, string Telefono, int Original_IdUsuario, string Original_Nombre, string Original_Apellido, string Original_Email, string Original_Telefono, int IdUsuario) {
            if ((Nombre == null)) {
                throw new global::System.ArgumentNullException("Nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellido, string Email, string Telefono, int Original_IdUsuario, string Original_Nombre, string Original_Apellido, string Original_Email, string Original_Telefono) {
            return this.Update(Nombre, Apellido, Email, Telefono, Original_IdUsuario, Original_Nombre, Original_Apellido, Original_Email, Original_Telefono, Original_IdUsuario);
        }
    }
